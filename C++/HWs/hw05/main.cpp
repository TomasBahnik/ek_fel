...
int main(int argc, char *argv[])
{
    ...
    QDir imageDir(framesPath);
                  ...
                  QLabel* spinBoxLabel = new QLabel("Set speed:"); //todo - more fancy
                  ...
                  QObject::connect(addButton, &QPushButton::clicked, [&]() {
                      QString imagePath = QFileDialog::getOpenFileName(nullptr, "Select an image to add", QDir::homePath(), "Images (*.png *.jpg *.jpeg)");
